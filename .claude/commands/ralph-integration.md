...
**The Loop:**
1. **CDK Synth** - Validate CloudFormation templates
2. **CDK Deploy** - Deploy all stacks to AWS
3. **Integration Tests** - Run pytest -m integration
4. **Auto-Fix** - If failures, diagnose and fix automatically
5. **CDK Destroy** - Clean up all resources (guaranteed)
