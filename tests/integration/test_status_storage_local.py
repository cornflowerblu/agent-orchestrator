"""Local integration tests for status storage using moto.
...
@pytest.fixture
def status_storage(dynamodb_local):
    """Create status storage with mocked DynamoDB."""
    return StatusStorage(table_name="AgentStatus", region="us-east-1")
...
class TestStatusStorageLocal:
    """Local integration tests for status storage."""
